...
class ArchiveGenerator:
        ...
        for archive_file in archive_files:
            with open(archive_file, 'r', encoding='utf-8') as f:
                ...
                weeks.append({
                    ...
                    'total_videos': data['source_data']['total_videos'],
                    'total_creators': data['source_data']['total_creators'],
                    'summary_preview': data['analysis']['weekly_summary'][:200] + '...' if len(data['analysis']['weekly_summary']) > 200 else data['analysis']['weekly_summary']
                })
    ...
    def run_archive(self, source_file: Path):
        ...
        try:
            ...
            weeks = self.generate_archive_index()
