...
def expand_keywords(wiki_topics: Dict[str, str]) -> Dict[str, str]:
    ...
    expansions = {
        'cholesterol': {
            'url_key': 'cholesterol',
            'aliases': ['ldl', 'hdl', 'triglycerides', 'statins', 'lean mass hyper responder', 'ketosis', 'ketogenic']
        },
        'weight stall': {
        ...
        'fiber': {
            'url_key': 'fiber',
            'aliases': ['dietary fiber', 'fibre', 'constipation']
        },
        'dairy': {
            'url_key': 'dairy',
        ...
        'coffee': {
            'url_key': 'coffee',
            'aliases': ['caffeine', 'tea', 'caffeinated']
        },
        'scurvy': {
            'url_key': 'scurvy',
            'aliases': ['vitamin c', 'vitamin-c', 'ascorbic acid']
        },
        'digestion': {
            'url_key': 'digestion',
        ...
        'salt': {
            'url_key': 'salt',
            'aliases': ['sodium', 'sodium chloride', 'sea salt']
        },
        'electrolytes': {
        ...
        'budget': {
            'url_key': 'budget',
            'aliases': ['cost', 'affordable', 'cheap', 'inexpensive']
        },
        'critics': {
            'url_key': 'critics',
        ...
        'gout': {
            'url_key': 'gout',
            'aliases': ['uric acid', 'purine', 'joint pain']
        },
        'beer gout': {
            'url_key': 'beer-gout',
            'aliases': ['beer', 'fermented', 'hops']
        },
    }
    ...
    for base_keyword, config in expansions.items():
        ...
        for key, val in wiki_topics.items():
            if url_key in key or key.replace(' ', '-') == url_key or key.replace(' ', '-') == url_key.replace('-', ''):
                url = val
                break
