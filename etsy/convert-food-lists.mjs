...
const file = (f) => 'file://' + resolve('products/' + f);
...
await p1.pdf({
  path: 'products/diet-food-list-landscape-letter.pdf',
  landscape: true,
  width: '11in',
  height: '8.5in',
...
await p1.pdf({
  path: 'products/diet-food-list-landscape-a4.pdf',
  landscape: true,
  width: '297mm',
  height: '210mm',
  margin: { top: 0, bottom: 0, left: 0, right: 0 },
...
await p1.goto(file('diet-food-list-landscape.html'));
await p1.screenshot({ path: 'products/mockup-landscape.png', fullPage: true });
...
await p2.pdf({
  path: 'products/diet-food-list-pages.pdf',
  width: '8.5in',
  height: '11in',
...
await p2.goto(file('diet-food-list-pages.html'));
await p2.screenshot({ path: 'products/mockup-portrait.png', fullPage: false });
console.log('  ✅ mockup-portrait.png');

await browser.close();
console.log('\nDone! 3 PDFs + 2 mockups ready in products/');
