...
- **Beads filed:** (P1) KD indexation dead — 20/20 newest posts "unknown to Google", 0 clicks 5 weeks; (P1) ISSUE-067 upstream DNS/MX signup guard is uncommitted and undeployed; (P2) Pinterest queue drains faster than the replenisher refills.
- **Recurring-issues:** added **ISSUE-068** (KD posts never discovered by Google). Corrected ISSUE-067's third attempt from "shipped" to "written, not committed or deployed" — the working tree still holds it.
