...
// ===========================================================================
{
  ...
  check('D', 'the meal plan is still built', !generateMealPlan('Ann Whitfield', d).includes(REFERRAL));
  check('D', 'the Starter Kit still carries the carb ceiling',
    generateStarterKit('Ann Whitfield', d).includes(CARB_CEILING));
...
// ===========================================================================
{
  ...
  check('G', 'targetsLine consults the ketogenic gate',
    /restrictKetogenicProtocol/.test(idx.slice(idx.indexOf('function targetsLine'), idx.indexOf('function targetsLine') + 1200)));
}
